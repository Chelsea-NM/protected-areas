...
class WdpaOecm(models.Model):
    ...
    rep_m_area = models.CharField(max_length=255, blank=True, null=True)
    gis_m_area = models.CharField(max_length=255, blank=True, null=True)
    rep_area = models.CharField(max_length=255, blank=True, null=True)
    gis_area = models.CharField(max_length=255, blank=True, null=True)
